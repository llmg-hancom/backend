...
from .get_group_members import router as get_group_member_router
...
from .update_group_info import router as update_group_info_router
...
router.include_router(get_group_member_router, prefix="/groups", tags=["그룹"])
router.include_router(update_group_info_router, prefix="/groups", tags=["그룹"])
router.include_router(delete_group_router, prefix="/groups", tags=["그룹"])
